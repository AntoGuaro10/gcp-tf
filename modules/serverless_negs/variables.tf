...
variable "subnetwork" {
  description = "Subnetwork for INTERNAL_SELF_MANAGED load balancing scheme"
  type        = string
  default     = "default"
}
...
variable "address_type" {
  description = "The address type of IP, INTERNAL or EXTERNAL"
  type        = string
  default     = "INTERNAL"
}
...
variable "match_host" {
  description = "A list of string matching hostname"
  type        = list(string)
  default     = ["*"]
}

variable "match_path" {
  description = "A list of string matching specific paths"
  type        = list(string)
  default     = ["/*"]
}