...
variable "resource_labels" {
  description = "The resource labels to be applied each node for cost filtering"
  type        = map(string)
  default     = {}
  nullable    = true
}
...
variable "reservation_name" {
  description = "Name of the reservation to consume."
  type        = string
  default     = null
  nullable = true
}
...
variable "cgroup_mode" {
  description = "(Optional) Possible cgroup modes that can be used"
  type        = string
}